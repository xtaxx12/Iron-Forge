  ...
  return (
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden bg-hero-pattern bg-cover bg-center bg-no-repeat bg-fixed">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-gym-accent font-bold tracking-[0.2em] uppercase mb-4 animate-fade-in-up font-montserrat text-sm md:text-base">
          Bienvenido al templo
        </h2>
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white mb-6 font-oswald uppercase tracking-tight leading-none drop-shadow-lg">
          Forja Tu <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-gym-accent to-yellow-200">
            Mejor Versión
          </span>
        </h1>
        <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-300 mb-10 font-light font-roboto">
